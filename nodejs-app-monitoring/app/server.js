...
app.get('/', function (req, res) {
    // DEMO ONLY: this simulates a random 0.5-10s "work" delay with setTimeout and
    // records the SIMULATED elapsed time in the histogram AFTER the HTTP response
    // has already been sent. It is NOT a real request-latency measurement, and it
    // is lost if the process exits before the timeout fires. It exists purely to
    // fill the http_request_duration_seconds histogram for the Grafana dashboard.
    var start = new Date()
